...
*/
function(t,i){t.fp_scrolloverflow=function(){t.IScroll||(t.IScroll=module.exports);var s="fp-scrollable",e="."+s,o="active",n=".fp-section",r=".fp-section.active",h=".fp-slide",a=".fp-tableCell",l="fp-auto-height-responsive";function c(){var s=this;function e(){var t;fp_utils.hasClass(i.body,"fp-responsive")?(t=s.options.scrollOverflowHandler,r((function(i){fp_utils.hasClass(fp_utils.closest(i,n),l)&&t.remove(i)}))):r(o)}function o(t){if(!fp_utils.hasClass(t,"fp-noscroll")){fp_utils.css(t,{overflow:"hidden"});var i,e=s.options.scrollOverflowHandler,o=e.wrapContent(),r=fp_utils.closest(t,n),h=e.scrollable(t),l=function(t){var i=fp_utils.closest(t,n);return null!=i?parseInt(getComputedStyle(i)["padding-bottom"])+parseInt(getComputedStyle(i)["padding-top"]):0}(r);null!=h?i=e.scrollHeight(t):(i=t.scrollHeight,s.options.verticalCentered&&(i=p(a,t)[0].scrollHeight));var c=fp_utils.getWindowHeight(),d=c-l;i+l>c?null!=h?e.update(t,d):(s.options.verticalCentered?(fp_utils.wrapInner(p(a,t)[0],o.scroller),fp_utils.wrapInner(p(a,t)[0],o.scrollable)):(fp_utils.wrapInner(t,o.scroller),fp_utils.wrapInner(t,o.scrollable)),e.create(t,d,s.iscrollOptions)):e.remove(t),fp_utils.css(t,{overflow:""})}}function r(t){p(n).forEach((function(i){var s=p(h,i);s.length?s.forEach((function(i){t(i)})):t(i)}))}s.options=null,s.init=function(o,n){return s.options=o,s.iscrollOptions=n,"complete"===i.readyState&&(e(),fullpage_api.shared.afterRenderActions()),t.addEventListener("load",(function(){e(),fullpage_api.shared.afterRenderActions()})),s},s.createScrollBarForAll=e,s.createScrollBar=o}IScroll.prototype.wheelOn=function(){this.wrapper.addEventListener("wheel",this),this.wrapper.addEventListener("mousewheel",this),this.wrapper.addEventListener("DOMMouseScroll",this)},IScroll.prototype.wheelOff=function(){this.wrapper.removeEventListener("wheel",this),this.wrapper.removeEventListener("mousewheel",this),this.wrapper.removeEventListener("DOMMouseScroll",this)};var p=null,d=null,u={refreshId:null,iScrollInstances:[],lastScrollY:null,hasBeenInit:!1,iscrollOptions:{scrollbars:!0,mouseWheel:!0,hideScrollbars:!1,fadeScrollbars:!1,disableMouse:!0,interactiveScrollbars:!0},init:function(i){p=fp_utils.$,d=i;var s="ontouchstart"in t||navigator.msMaxTouchPoints>0||navigator.maxTouchPoints;return u.iscrollOptions.click=s,u.hasBeenInit=!0,u.iscrollOptions=fp_utils.deepExtend(u.iscrollOptions,i.scrollOverflowOptions),(new c).init(i,u.iscrollOptions)},toggleWheel:function(t){p(e,p(r)[0]).forEach((function(i){var s=i.fp_iscrollInstance;null!=s&&(t?s.wheelOn():s.wheelOff())}))},setIscroll:function(t,i){if(u.hasBeenInit){var s=fp_utils.closest(t,e)||p(e,t)[0],o=i?"enable":"disable";s&&s.fp_iscrollInstance[o]()}},onLeave:function(){u.toggleWheel(!1)},beforeLeave:function(){u.onLeave()},afterLoad:function(){u.toggleWheel(!0)},create:function(t,i,s){p(e,t).forEach((function(e){fp_utils.css(e,{height:i+"px"});var r=e.fp_iscrollInstance;null!=r&&u.iScrollInstances.forEach((function(t){t.destroy()})),r=new IScroll(e,s),u.iScrollInstances.push(r),fp_utils.hasClass(fp_utils.closest(t,n),o)||r.wheelOff(),e.fp_iscrollInstance=r}))},isScrolled:function(t,i){var s=i.fp_iscrollInstance;return!s||("top"===t?s.y>=0&&!fp_utils.getScrollTop(i):"bottom"===t?0-s.y+fp_utils.getScrollTop(i)+i.offsetHeight>=i.scrollHeight:void 0)},scrollable:function(t){return p(".fp-slides",t).length?p(e,p(".fp-slide.active",t)[0])[0]:p(e,t)[0]},scrollHeight:function(t){return p(".fp-scroller",p(e,t)[0])[0].scrollHeight},remove:function(t){if(null!=t){var i=p(e,t)[0];if(null!=i){var s=i.fp_iscrollInstance;null!=s&&s.destroy(),i.fp_iscrollInstance=null,fp_utils.unwrap(p(".fp-scroller",t)[0]),fp_utils.unwrap(p(e,t)[0])}}},update:function(t,i){clearTimeout(u.refreshId),u.refreshId=setTimeout((function(){u.iScrollInstances.forEach((function(t){t.refresh(),fullpage_api.silentMoveTo(fp_utils.index(p(r)[0])+1)}))}),150),fp_utils.css(p(e,t)[0],{height:i+"px"}),d.verticalCentered&&fp_utils.css(p(e,t)[0].parentNode,{height:i+"px"})},wrapContent:function(){var t=i.createElement("div");t.className=s;var e=i.createElement("div");return e.className="fp-scroller",{scrollable:t,scroller:e}}};return{iscrollHandler:u}}()}(window,document);